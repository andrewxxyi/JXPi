...
public class jxJson implements Iterable<jxJson>
{
	...
	{
		assert SubName!=null: "需要给出子对象的名字";
        assert Type== NodeType.Object: "只有对象才可能直接读取子节点的值";
	...
	{
        assert Type== NodeType.Array: "只有数组才能读取子元素";
		return Array;
	}
    ...
    {
    	assert sub!=null: "不能添加空的子对象";
        assert Type== NodeType.Object: "只有对象节点才能添加子对象";
    ...
    {
    	assert el!=null: "不能添加空的子元素";
        assert Type== NodeType.Array: "只有数组节点才能添加子元素";
		synchronized (Array)
        {
