...
public class jxHttpClient {
    ...
    public void addQueryString(String name,String value) {
        query = utils.StringAdd(query, "&", name + "=" + value);
    }
    ...
    private HttpResponse execute(HttpRequestBase method) {
        return (HttpResponse) jxTimer.asyncFunc(new IFunc() {
            @Override
            public Object Do(Object param) throws Exception {
                HttpRequestBase m = (HttpRequestBase) param;
    ...
    public jxJson post(String path, jxJson jsonParam) throws Exception {
        ...
        HttpResponse result = execute(method);
        /**读取服务器返回过来的json字符串数据**/
