...
public class Trans {
	...
	public static String TransToString_Date(Date dt) {
		Calendar c = Calendar.getInstance();
		c.setTime(dt);
		return c.get(Calendar.YEAR) + "-" + String.format("%02d",(c.get(Calendar.MONTH) + 1)) + "-" + String.format("%02d",c.get(Calendar.DATE));
	}

	public static String TransToString_Time(Date dt) {
		Calendar c = Calendar.getInstance();
		c.setTime(dt);
		return c.get(Calendar.HOUR) + ":" + String.format("%02d",c.get(Calendar.MINUTE)) + ":" + String.format("%02d",c.get(Calendar.SECOND));
	}
