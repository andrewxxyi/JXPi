...
class SN
{
	...
	static jxStateMachine<SNState,Event_InputChar,CallParam> SNSM=null;
    static
    {
...
class SN_InputCommon implements IDoSomething<CallParam>
{
	@Override
...
class SN_StartModel implements IDoSomething<CallParam>
{
	@Override
	public void Do(CallParam param) 
	{
...
class SN_ModelInput implements IDoSomething<CallParam>
{
	@Override
	public void Do(CallParam param) 
	{
...
class SN_EndModel implements IDoSomething<CallParam>
{
	@Override
