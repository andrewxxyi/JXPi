    ...
    class MyIterator implements Iterator<byte[]>
    {
        ...
        {  
			...
			try {
    			...
    			bs=utils.TransLongToByteArray(MsgTime);
    			System.arraycopy(bs, 0, Block, 32, 8);
    			bs=ReceiverIDSTR.getBytes("UTF8");
			} catch (UnsupportedEncodingException e) {
				return null;
			}
			System.arraycopy(bs, 0, Block, 40, 32);
			bs=utils.TransIntToByteArray(MsgLength);
			System.arraycopy(bs, 0, Block, 72, 4);
			bs=utils.TransIntToByteArray(BlockNum);
			System.arraycopy(bs, 0, Block, 76, 4);
...
class AutoDeleteFromBuffer implements IDoSomething<CallParam>
{
