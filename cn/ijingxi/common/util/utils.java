...
import cn.ijingxi.common.Process.Right;
import cn.ijingxi.common.app.*;
import cn.ijingxi.common.intelControl.FrontDevice;
import cn.ijingxi.common.intelControl.jxLua;
import cn.ijingxi.common.msg.Message;
import cn.ijingxi.common.msg.MessageType;
import cn.ijingxi.common.msg.MsgAgent;
import cn.ijingxi.common.msg.MsgGroup;
...
public class utils {
	public static void Init() throws Exception {
		...
		Group.Init();
		SerialNumber.Init();
		cn.ijingxi.common.app.Right.Init();

		FlowChart.Init();
		FlowChartInstance.Init();
		jxMission.Init();
		...
		Trans.AddEunmType(InstanceEvent.Error);
		...
		Trans.AddEunmType(LogPriority.debug);
		Trans.AddEunmType(jxDataType.Boolean);

		Trans.AddEunmType(MessageType.Event);
