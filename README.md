...
3、python用于在后台充分利用python所积累的丰富资源来扩充系统的功能。利用JXPi平台提供的非常简便的扩展机制，可方便的将python代码集成到JXPi平台中来。随着PythonPi平台的开发，目前也提供了使用脚本和在线编程两种方式用python语言来执行控制功能的能力
...
- 因PythonPi的开发本版本有了非常重大的调整，主要是增加使用python作为前端控制脚本的功能、增加了i2c控制能力
